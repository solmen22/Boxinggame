...
public class enemyhpscripthpscript : MonoBehaviour
{
    // Start is called before the first frame update
    [SerializeField] private Image playerhealthImage;
    [SerializeField] private Image playerburnImage;
    ...
    {
        playerhealthImage.DOFillAmount(targetRate, duration).OnComplete(() =>
        {
            playerburnImage.DOFillAmount(targetRate, duration * 0.5f).SetDelay(0.2f);
            OnHpAnimationComplete?.Invoke(); // ŠO•”‚É’Ê’m
        });
