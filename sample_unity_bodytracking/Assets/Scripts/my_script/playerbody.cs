...
public class bodymode : MonoBehaviour
{
    ...
    private int er = 50;
    private int elbow_center_angle = 25;
    public Transform right_elbow_transform;
    public Transform left_elbow_transform;
    ...
    private bool beforerightpunch = false;
    private bool beforeleftpunch = false;
    private bool beforecounterrightpunch = false;
    private bool beforecounterleftpunch =false;
    ...
    void Update()
    {
        float left_elbow_angle = left_elbow_transform.localEulerAngles.z;
        float body_angle = Hips.localEulerAngles.z;
        ...
        /*if (beforecounterleftpunch == true && counterleftpunch == false && blocking == true)
        {
            Mode.SetText("counterleftpunch!");
            counterleftpunching = true;
            animator.SetTrigger("counterleftpunch");
            

        }
        else if(beforecounterrightpunch == true && counterrightpunch == false && blocking == true)
        {

            Mode.SetText("counterrightpunch!");
            counterrightpunching = true;
            animator.SetTrigger("counterrightpunch");


        }
        else if (beforerightpunch == true && rightpunch == false && blocking == true)
        {

            animator.SetTrigger("rightpunch");
            rightpunching = true;
            Mode.SetText("rightpunch!");

        }
        else if (beforeleftpunch == true && leftpunch == false && blocking == true)
        {
        ...
        beforeleftpunch = leftpunch;
        beforerightpunch = rightpunch;
        beforecounterrightpunch= counterrightpunch;
        beforecounterleftpunch= counterleftpunch;*/
